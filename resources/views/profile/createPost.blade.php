...
<body class="bg-gray-100">
    {{-- Navigation Bar --}}
    <div
        class=" bg-slate-300 h-14 flex flex-row justify-between items-center px-4 shadow-xl shadow-slate-400 sticky top-0 z-10 mb-6">
        {{-- Logo --}}
        ...
        <div class="relative flex-grow max-w-md">
            <input type="text" placeholder="Search"
                class="w-full h-8 px-4 rounded-full bg-gray-100 text-gray-800 focus:outline-none focus:ring focus:border-gray-400 text-center">
